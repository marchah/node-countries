...
describe('Unit Testing ->', () => {
    ...
    describe('alpha2 ->', () => {
        it('should return an object', () => {
            chai_1.expect(index_1.countries[Andorra.alpha2]).to.be.an('object');
        });
        it('should have `alpha2`, `alpha3`, `countryCallingCodes`, `currencies`, `ioc`, `languages`, `name`, `status` `provinces`, `alias`, getProvinceByName` and `findProvinceByName` as object keys', () => {
            Object.keys(index_1.countries).forEach((key) => {
                if (lodash_1.default.isString(key) && key.length === 2) {
                    chai_1.expect(index_1.countries[key]).to.have.all.keys([
                        'alpha2',
                        'alpha3',
                        'countryCallingCodes',
                        'currencies',
    ...
    describe('Methods ->', () => {
        ...
        describe('Province Search #', () => {
            describe('getProvinceByName()', () => {
                it('should be a function', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].getProvinceByName).to.be.a('function');
                });
                it('should return `null` when no provinces', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].getProvinceByName()).to.eql(null);
                });
                it('should return `null` when no argument', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByName()).to.eql(null);
                });
                it('should return province object when find it', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByName('Newfoundland and Labrador')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when find it by ignoring case', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByName('NewfoUndland and LabrAdor')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return `null` when searching alias with no useAlias parameter', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByName('NewfoUndland')).to.eql(null);
                });
                it('should return `null` when searching alias with useAlias parameter `false`', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByName('NewfoUndland', false)).to.eql(null);
                });
                it('should return province object when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByName('NewfoUndland', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province by ignoring case when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByName('LabrAdor', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when searching alias with useAlias parameter `true` and province has no alias', () => {
                    chai_1.expect(index_1.countries.US.getProvinceByName('caLifoRnia', true)).to.eql(California);
                });
            });
            describe('findProvinceByName()', () => {
                it('should be a function', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].findProvinceByName).to.be.a('function');
                });
                it('should return `null` when no provinces', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].findProvinceByName()).to.eql(null);
                });
                it('should return `null` when no argument', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByName()).to.eql(null);
                });
                it('should return province object when find it', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByName('Newfoundland and Labrador')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when find it by ignoring case', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByName('NewfoUndland and LabrAdor')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return `null` when searching alias with no useAlias parameter', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByName('NewfoUndland')).to.eql(null);
                });
                it('should return `null` when searching alias with useAlias parameter `false`', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByName('NewfoUndland', false)).to.eql(null);
                });
                it('should return province object when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByName('NewfoUndland', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province by ignoring case when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByName('LabrAdor', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when searching alias with useAlias parameter `true` and province has no alias', () => {
                    chai_1.expect(index_1.countries.US.findProvinceByName('caLifoRnia', true)).to.eql(California);
                });
            });
            describe('getProvinceByNameOrShortName()', () => {
                it('should be a function', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].getProvinceByNameOrShortName).to.be.a('function');
                });
                it('should return `null` when no provinces', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].getProvinceByNameOrShortName()).to.eql(null);
                });
                it('should return `null` when no argument', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName()).to.eql(null);
                });
                it('should return province object when find it', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('Newfoundland and Labrador')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when find it using short name', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('NL')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when find it by ignoring case', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('NewfoUndland and LabrAdor')).to.eql(NewfoundlandAndLabrador);
                });
                ...
                it('should return `null` when country has no short name province', () => {
                    chai_1.expect(index_1.countries.BO.getProvinceByNameOrShortName('VA')).to.eql(null);
                });
                it('should return `null` when searching alias with no useAlias parameter', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('NewfoUndland')).to.eql(null);
                });
                it('should return `null` when searching alias with useAlias parameter `false`', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('NewfoUndland', false)).to.eql(null);
                });
                it('should return province object when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('NewfoUndland', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when searching alias with useAlias parameter `true` using short name', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('NL', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province by ignoring case when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.getProvinceByNameOrShortName('LabrAdor', true)).to.eql(NewfoundlandAndLabrador);
                });
                ...
                it('should return `null` when country has no short name province with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.BO.getProvinceByNameOrShortName('VA', true)).to.eql(null);
                });
                it('should return province object when searching alias with useAlias parameter `true` and province has no alias', () => {
                    chai_1.expect(index_1.countries.US.getProvinceByNameOrShortName('caLifoRnia', true)).to.eql(California);
                });
            });
            describe('findProvinceByNameOrShortName()', () => {
                it('should be a function', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].findProvinceByNameOrShortName).to.be.a('function');
                });
                it('should return `null` when no provinces', () => {
                    chai_1.expect(index_1.countries[Andorra.alpha2].findProvinceByNameOrShortName()).to.eql(null);
                });
                it('should return `null` when no argument', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName()).to.eql(null);
                });
                it('should return province object when find it', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName('Newfoundland and Labrador')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when find it using short name', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName('NL')).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province object when find it by ignoring case', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName('NewfoUndland and LabrAdor')).to.eql(NewfoundlandAndLabrador);
                });
                ...
                it('should return `null` when country has no short name province', () => {
                    chai_1.expect(index_1.countries.BO.findProvinceByNameOrShortName('VA')).to.eql(null);
                });
                it('should return `null` when searching alias with no useAlias parameter', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName('NewfoUndland')).to.eql(null);
                });
                it('should return `null` when searching alias with useAlias parameter `false`', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName('NewfoUndland', false)).to.eql(null);
                });
                it('should return province object when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName('NewfoUndland', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return province by ignoring case when searching alias with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.CA.findProvinceByNameOrShortName('LabrAdor', true)).to.eql(NewfoundlandAndLabrador);
                });
                it('should return `null` when country has no short name province with useAlias parameter `true`', () => {
                    chai_1.expect(index_1.countries.BO.findProvinceByNameOrShortName('VA', true)).to.eql(null);
                });
                it('should return province object when searching alias with useAlias parameter `true` and province has no alias', () => {
                    chai_1.expect(index_1.countries.US.findProvinceByNameOrShortName('caLifoRnia', true)).to.eql(California);
                });
            });
        });
    });

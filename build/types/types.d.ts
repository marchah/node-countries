...
export interface Country extends CountryRaw {
    ...
    getProvinceByNameOrShortName(nameOrShortName?: Maybe<string>, useAlias?: boolean): Maybe<Province>;
    findProvinceByNameOrShortName(nameOrShortName?: Maybe<string>, useAlias?: boolean): Maybe<Province>;
}
